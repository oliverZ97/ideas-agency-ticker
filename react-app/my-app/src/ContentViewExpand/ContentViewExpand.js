...
import "./ContentViewExpand.css";

class ContentViewExpand extends Component {
    render() {
        return (
            <div className="ContentViewExpand">
                ...
                <div className="date-agency">
                    <h6 className="detail_date">11. April 2019</h6>
                    <h6 className="detail_agency">DPA - LNO</h6>
                </div>
                <div className="author-tags">
                    <h6 className="detail_author">Bernhard Sprengel</h6>
                    <h6 className="detail_tags" >Tags: Verkehr, Hamburg</h6>
                </div>
                <div className="img-text-author">
...
export default ContentViewExpand;